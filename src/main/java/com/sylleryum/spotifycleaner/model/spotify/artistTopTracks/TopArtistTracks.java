...
public class TopArtistTracks {
    ...
    public TopArtistTracks() {
    }

    public TopArtistTracks(String name) {
        this.name = name;
    }

    public TopArtistTracks(Album album, List<Artist_> artists, Integer discNumber, Integer durationMs, Boolean explicit, ExternalIds externalIds, ExternalUrls___ externalUrls, String href, String id, Boolean isLocal, Boolean isPlayable, String name, Integer popularity, String previewUrl, Integer trackNumber, String type, String uri, Map<String, Object> additionalProperties) {
        this.album = album;
